...
export default function BlogDetailPage() {
    return (
        <main className="min-h-screen bg-[#fdfdfd] pt-24 pb-0">
            {/* Hero Section */}
            <section className="relative pt-24 pb-32 overflow-hidden mx-4 lg:mx-8 rounded-[40px] md:rounded-[60px] bg-[#0a0f1d] flex flex-col items-center justify-center min-h-[50vh]">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                    <MotionWrapper variants={fadeUp} className="mb-6">
                        <span className="inline-flex items-center px-3 py-1 rounded-full border border-white/10 bg-white/5 text-[11px] font-bold text-gray-300 tracking-wider uppercase backdrop-blur-sm">
                            Jan 6, 2026
                        </span>
                    </MotionWrapper>

                    <MotionWrapper variants={fadeUp} delay={0.1}>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6 leading-[1.15] drop-shadow-sm max-w-3xl mx-auto">
                            Building clarity through better SaaS dashboard design
                        </h1>
                    </MotionWrapper>

                    <MotionWrapper variants={fadeUp} delay={0.2}>
                        <p className="text-[17px] text-gray-400 font-medium max-w-2xl mx-auto">
            ...
            <section className="py-20">
                <div className="max-w-[720px] mx-auto px-6 lg:px-10">
                    <MotionWrapper variants={fadeUp} className="prose prose-lg md:prose-xl prose-gray max-w-none text-gray-600">
                        <h2 className="text-2xl md:text-[28px] font-bold text-gray-900 mb-6 leading-tight tracking-tight mt-10">
                            The most common business debate isn't as black and white as you might think
                        </h2>
                        <p className="mb-6 text-[16px] leading-[1.8] font-medium text-gray-600">
                        ...
                        <ul className="mb-8 space-y-2 text-[16px] leading-[1.8] font-medium text-gray-600 pl-4 list-disc marker:text-gray-300">
                        ...
                        <p className="mb-12 text-[16px] leading-[1.8] font-medium text-gray-600">
                        ...
                        <div className="my-14 rounded-2xl overflow-hidden shadow-sm border border-gray-100 bg-[#f5f5f5] p-2 aspect-[16/9] relative group">
                            ...
                            <div className="w-full h-full rounded-xl bg-gradient-to-br from-red-400 to-rose-600 flex flex-col items-center justify-center p-8 relative overflow-hidden">
                                ...
                                <h3 className="text-white text-3xl md:text-5xl font-bold tracking-tight mb-2 drop-shadow-md z-10">
                                    TRIGGERS &
                                </h3>
                                <h3 className="text-white text-3xl md:text-5xl font-bold tracking-tight drop-shadow-md z-10">
                                    ANIMATIONS
                                </h3>
                            </div>
                        </div>

                        <h2 className="text-2xl md:text-[28px] font-bold text-gray-900 mb-6 leading-tight tracking-tight mt-14">
                            Ten questions you should answer truthfully
                        </h2>

                        <p className="mb-8 text-[16px] leading-[1.8] font-medium text-gray-600">
                        ...
                        {/* Callout Box */}
                        <div className="my-10 p-8 md:p-10 rounded-[20px] bg-gray-50 border border-gray-200">
                            <p className="text-[17px] leading-[1.8] font-semibold text-gray-700 italic text-center text-balance max-w-xl mx-auto">
