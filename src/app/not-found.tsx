...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-[#fdfdfd] pt-32 pb-0 flex flex-col items-center justify-center">
            <div className="flex-1 flex flex-col items-center justify-center text-center px-6 mt-10 md:mt-20">
                ...
                <MotionWrapper variants={fadeUp} delay={0.2}>
                    <p className="text-gray-500 text-[15px] max-w-sm mx-auto mb-8 font-medium">
                        The page you are looking for doesn't exist or has been moved.
                    </p>
                </MotionWrapper>

                <MotionWrapper variants={fadeUp} delay={0.3}>
                    <Link href="/" className="mt-auto inline-flex items-center gap-3 px-1.5 py-1.5 pr-5 bg-gray-900 text-white rounded-full font-semibold text-[13px] w-fit hover:bg-gray-800 transition-transform duration-200 hover:-translate-y-1 shadow-md">
