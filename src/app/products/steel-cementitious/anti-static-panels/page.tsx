...
import { ShieldCheck, ArrowUpToLine, Zap, Settings, Shield, LayoutGrid, Download } from "lucide-react";
import { motion } from "framer-motion";

export default function AntiStaticPanelsPage() {
    return (
        <main className="min-h-screen bg-white">
            <ProductHero
                ...
                breadcrumbs={[
                    ...
                    { name: "Anti-Static HP Laminate & PVC Panels", href: "/products/steel-cementitious/anti-static-panels" }
                ]}
            />
            ...
            <section className="py-24 md:py-32 bg-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 leading-tight">Enhanced Electrostatic Control.</h2>
                            <div className="flex flex-col gap-6 text-zinc-600 leading-relaxed text-lg font-light">
                                <p>Standard laminated panels are epoxy coated unitized Shells consisting of a flat steel top sheet welded to a formed steel bottom sheet. The panel is in filled with a lightweight proprietary cementitious mixture.</p>
                                <p>The top finishes is of High Pressure Anti-Static Laminate or PVC finish. Manufactured to exacting tolerances, these non-combustible rigid, solid panels deliver the ultimate in strength and durability with the convenience of lightweight construction.</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="w-full h-full bg-zinc-200 flex items-center justify-center">
                                {/* <Image src="http://dazzletech.in/uploads/products/laminate-pvc-panel.jpg" alt="Anti-Static High pressure laminate" fill className="object-cover group-hover:scale-105 transition-transform duration-700" /> */}
                                <Shield size={64} className="text-zinc-300" strokeWidth={1} />
                            </div>
                        </motion.div>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <ul className="flex flex-col gap-6">
                                <li className="flex flex-col gap-1">
                                    ...
                                    <span className="text-zinc-900 font-medium leading-snug">Anti-static High-pressure laminate / PVC</span>
                                </li>
                                <li className="flex flex-col gap-1">
                                    <span className="text-xs font-bold tracking-widest uppercase text-zinc-400">Understructure Type</span>
                                    <span className="text-zinc-900 font-medium">Edge Support Rigid Grid (ESRG)</span>
                                </li>
                                <li className="flex flex-col gap-1">
