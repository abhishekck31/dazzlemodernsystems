    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <div className="pb-24">
                <TechnicalHighlights
                    highlights={[
                        { title: "Standard 600mm x 600mm overall dimension", icon: <Maximize size={24} /> },
                        { title: "Viewing area: 300x300, 400x400 or 500x500mm", icon: <Eye size={24} /> },
                        { title: "Ideal for frequent critical monitoring", icon: <Focus size={24} /> },
                        { title: "Engineered for normal walking loads", icon: <Footprints size={24} /> },
                    ]}
                />
            </div>
