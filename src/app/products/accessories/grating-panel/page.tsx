...
export default function GratingPanelPage() {
    return (
            ...
            <section className="py-24 md:py-24 bg-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 leading-tight">Optimized Underfloor Air Distribution.</h2>
                            <div className="flex flex-col gap-6 text-zinc-600 leading-relaxed text-lg font-light">
                                <p>Grating Panels are 600 x 600mm raised access floor panels specially constructed to allow for highly efficient air flow distribution from under the raised access floor.</p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        >
                            ...
                            <ul className="flex flex-col gap-6">
                                ...
                                <li className="flex flex-col gap-1">
                                    ...
                                    <span className="text-zinc-900 font-medium">46% <span className="text-zinc-500 font-normal text-sm ml-1">(Oval arrangement)</span></span>
                                </li>
                            </ul>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-6 text-zinc-600 leading-relaxed font-light mt-2">
                                <p>Grating floor panels can be equipped with volume control aluminum dampers fixed to the bottom of the panel.</p>
