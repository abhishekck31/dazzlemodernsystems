...
export default function BareEncapsulatedPanelsPage() {
    return (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-6 text-zinc-600 leading-relaxed text-lg font-light">
                                <p>Bare Encapsulated panels consist of high density composite wood core glued to and encased in hot dipped galvanized formed steel sheets.</p>
