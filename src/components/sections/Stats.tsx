...
const stats = [
    ...
    { value: 45, suffix: "M+", label: "Tasks automated daily", color: "text-brand-500" },
                    ...
                    {stats.map((stat, i) => (
                        <MotionWrapper key={i} variants={fadeUp} className="pt-8 md:pt-0">
                            <div className="flex flex-col items-center justify-center">
                                <div className="bg-slate-50 rounded-full py-2 px-4 shadow-sm border border-border mb-6 group hover:scale-105 transition-transform">
                                    <span className={`text-3xl md:text-[40px] font-black ${stat.color} tracking-tighter`}>
