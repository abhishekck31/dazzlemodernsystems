...
const tools = [
    ...
    { name: "Database Logs", icon: <Database className="w-6 h-6 text-brand-500" />, desc: "Historical records" },
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <MotionWrapper variants={fadeUp} className="flex-1">
                        <div className="bg-slate-50 rounded-lg p-10 border border-border h-full flex flex-col items-start justify-center">
                            <h3 className="text-2xl font-bold text-foreground mb-4">Connect everything</h3>
                            <p className="text-muted-foreground text-lg mb-8">
                                Seamlessly bring your favorite apps into one unified dashboard. From messaging to deep analytics.
                            </p>
                            <button className="px-6 py-3 bg-black text-white rounded-full font-semibold hover:bg-slate-800 transition-colors">
                    ...
                    <MotionWrapper variants={staggerContainer} className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {tools.map((tool, i) => (
                            <MotionWrapper
                                key={i}
                                variants={fadeUp}
                                className="bg-white p-6 rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow flex items-start gap-4"
                            >
