        ...
        <section className="py-24 bg-white border-y border-border">
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <MotionWrapper variants={fadeUp} className="text-center mb-16">
                    ...
                    <p className="text-muted-foreground mt-5 text-lg max-w-[65ch] mx-auto">
                ...
                <MotionWrapper variants={staggerContainer} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                    {facilities.map((fac, i) => (
                        <MotionWrapper key={i} variants={fadeUp} className="group cursor-pointer">
                            <div className="relative h-[220px] md:h-[260px] rounded-lg overflow-hidden mb-6 bg-slate-900 border border-border shadow-sm transition-all duration-500 group-hover:shadow-2xl group-hover:-translate-y-2">
                                <Image
                                    src={fac.img}
                                    alt={fac.name}
                                    fill
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-foreground leading-tight">{fac.name}</h3>
                                <p className="text-base text-muted-foreground mt-2 font-medium">{fac.desc}</p>
                            </div>
                        </MotionWrapper>
                    ))}
                </MotionWrapper>
