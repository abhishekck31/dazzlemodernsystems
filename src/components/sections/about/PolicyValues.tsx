...
export function PolicyValues() {
    return (
        <section className="py-24 md:py-24 bg-white relative overflow-hidden" id="policy">
            {/* Subtle glow elements */}
            <div className="absolute top-1/4 right-0 w-[400px] h-[400px] bg-indigo-500/5 rounded-full blur-[150px] pointer-events-none" />
            <div className="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-brand-500/5 rounded-full blur-[150px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
                <MotionWrapper variants={fadeUp} className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-[40px] font-bold tracking-tight text-foreground leading-tight mb-8">
                        The foundation of our success
                    </h2>
                    <p className="text-[16px] md:text-[18px] text-muted-foreground max-w-[65ch] mx-auto font-medium leading-[1.8] text-balance">
                    ...
                    <MotionWrapper variants={staggerContainer} className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8">
                        {coreValues.map((val, i) => (
                            <MotionWrapper
                                key={i}
                                variants={fadeUp}
                                className="px-6 py-4 bg-slate-50/50 rounded-2xl border border-border hover:border-border hover:shadow-sm hover:-translate-y-1 transition-all duration-300 font-bold text-[16px] text-foreground tracking-tight"
                            >
                                {val}
                            </MotionWrapper>
                        ))}
                ...
                <MotionWrapper variants={fadeUp} className="flex justify-center">
                    <div className="max-w-4xl w-full bg-muted p-10 md:p-12 rounded-lg border border-border shadow-sm text-center relative overflow-hidden">
                        ...
                        <p className="text-[16px] md:text-[18px] font-semibold text-slate-700 leading-[1.8] text-balance">
