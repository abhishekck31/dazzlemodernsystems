        ...
        <section className="py-24 bg-gray-50/50">
            <div className="max-w-6xl mx-auto px-6 lg:px-10">
                ...
                <MotionWrapper variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <MotionWrapper variants={fadeUp} className="bg-white p-10 lg:p-14 rounded-[32px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group">
                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-blue-400 group-hover:h-2 transition-all" />
                        <div className="w-14 h-14 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mb-8 border border-blue-100 shadow-sm group-hover:scale-110 transition-transform">
