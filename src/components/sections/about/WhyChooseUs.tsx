            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                    ...
                    <MotionWrapper variants={fadeUp} className="flex-1 w-full relative">
                        ...
                        <div className="relative z-10 w-full aspect-square md:aspect-[4/3] rounded-lg overflow-hidden shadow-2xl border border-white/10 bg-black/90">
                            <Image
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full px-6">
                                ...
                                <h3 className="text-[40px] md:text-[48px] font-extrabold text-white tracking-tight drop-shadow-lg mb-2">
                                    10,000+
                                </h3>
                                <p className="text-slate-300 font-medium text-sm md:text-base tracking-wide uppercase">Successful Installations globally</p>
                            </div>
                        </div>
                    </MotionWrapper>
                    ...
                    <MotionWrapper variants={staggerContainer} className="flex-1 w-full">
                        <MotionWrapper variants={fadeUp}>
                            ...
                            <h2 className="text-3xl md:text-[40px] font-bold tracking-tight text-foreground leading-tight mb-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8 mb-12">
                            {[
                                { title: "Dedicated Team", icon: Users, color: "text-brand-600", bg: "bg-brand-100" },
                                ...
                                return (
                                    <MotionWrapper key={i} variants={fadeUp} className="flex items-start gap-4 group cursor-default">
                                        ...
                                        <span className="font-bold text-foreground text-lg mt-2 tracking-tight group-hover:text-brand-600 transition-colors">{item.title}</span>
                                    </MotionWrapper>
                                );
                            })}
                        </div>
                        ...
                        <MotionWrapper variants={fadeUp}>
                            <button className="px-8 py-3.5 bg-white border border-border text-foreground font-bold rounded-full shadow-sm hover:shadow-md hover:-translate-y-1 transition-all flex items-center gap-2">
