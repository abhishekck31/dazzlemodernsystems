    ...
    return (
        <section className="py-24 bg-slate-50/50" id="products">
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <MotionWrapper variants={fadeUp} className="text-center mb-16 max-w-[65ch] mx-auto">
                    <p className="text-sm font-semibold tracking-wide text-brand-600 uppercase mb-3 text-center">
                        FEATURES
                    </p>
                ...
                >
                    {topFeatures.map((feature, i) => (
                        <MotionWrapper
                            key={i}
                            variants={fadeUp}
                            className="group bg-white rounded-lg p-8 border border-border shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                        >
                ...
                <MotionWrapper variants={fadeUp} delay={0.3}>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-white rounded-lg border border-border shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">

                        {/* Dark abstract image side */}
                        <div className="bg-slate-900 p-10 flex items-center justify-center relative min-h-[300px] overflow-hidden">
                            <div className="absolute inset-0 bg-brand-500/10 blur-[80px]" />
                            <div className="relative z-10 w-32 h-32 rounded-lg bg-gradient-to-tr from-blue-600 to-purple-600 flex items-center justify-center shadow-2xl group-hover:scale-105 transition-transform duration-500">
