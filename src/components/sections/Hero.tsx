...
export function Hero() {
    return (
        <section className="relative pt-32 pb-xl overflow-hidden bg-[#5a5a5a] rounded-b-[40px] md:rounded-b-[80px]">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10 flex flex-col items-center xl:flex-row xl:items-start gap-12 lg:gap-8 pt-10 pb-20">
                ...
                >
                    ...
                    <MotionWrapper variants={fadeUpQuick}>
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
                            Take control of your daily <span className="text-blue-300">Operations.</span>
                        </h1>
                    </MotionWrapper>
                    ...
                    <MotionWrapper variants={fadeUpQuick} className="flex flex-col sm:flex-row items-center gap-4 mb-16 xl:max-w-md">
                        <button className="w-full sm:w-auto px-8 py-3.5 bg-white text-black font-semibold rounded-full hover:bg-gray-100 transition-colors shadow-lg">
                            Get Started
                        </button>
                ...
                >
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-blue-500/20 blur-[100px] rounded-full z-0 pointer-events-none" />

                    <div className="relative z-10 w-full rounded-2xl md:rounded-[32px] overflow-hidden shadow-2xl border border-white/10 bg-black/40 xl:translate-x-10 xl:-translate-y-4">
                        <Image
